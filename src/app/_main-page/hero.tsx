...
const Hero = () => {
    ...
    return (
        <section className="relative bg-rose-50 overflow-hidden">
            ...
            <div className="absolute top-0 right-0 -mr-20 -mt-20 w-96 h-96
            rounded-full bg-pink-200 blur-3xl opacity-30"></div>
            <div className="absolute bottom-0 left-0 -ml-20 -mb-20 w-72 h-72
            rounded-full bg-rose-200 blur-3xl opacity-30"></div>
